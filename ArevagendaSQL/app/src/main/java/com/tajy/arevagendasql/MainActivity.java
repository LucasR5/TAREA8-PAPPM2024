package com.tajy.arevagendasql;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMostrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "http://192.168.23.207/API_WEB_SERVICE/recuperar.php?idUsuario=" + idusuario;
                recuperarData(url);
            }
        });
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "http://192.168.23.207/API_WEB_SERVICE/insertar.php?nombreapellido="
